    ...
    public void check(Plugin plugin) throws IOException {
        if (messages.getData().getString("reload") == null) {
            if (Main.language.equals("pl")) {
                ...
                messages.getData().set("logs.multi_accounts", "Gracz {player} ma wiele kont: {accounts}");
                messages.getData().set("logs.login_premium", "Gracz {player} pomyslnie zalogowal sie kontem premium");
                messages.getData().set("logs.autologin_session", "Gracz {player} pomyslnie zalogowal sie przez aktywna sesje");
                messages.getData().set("logs.unregister", "Gracz {player} pomyslnie wyrejestrowal sie");
                messages.getData().set("logs.register", "Gracz {player} pomyslnie zarejestrowal sie");
                messages.getData().set("logs.deregistering", "Gracz {player} pomyslnie zostal wyrejestrowany przez {sender}");
                messages.getData().set("logs.logging_out", "Gracz {player} pomyslnie sie wylogowal");
                messages.getData().set("logs.changepassword", "Gracz {player} pomyslnie zmienil haslo");
                messages.getData().set("logs.cannot_create_multiple_accounts", "Gracz {sender} pomyslnie zabral mozliwosc tworzenia kont dla {player}");
                messages.getData().set("logs.can_create_multiple_accounts", "Gracz {sender} pomyslnie nadal mozliwosc tworzenia kont dla {player}");
                messages.getData().set("logs.login", "Gracz {player} pomyslnie zalogowal sie przez haslo");
                messages.getData().set("logs.antibot_disable", "Ochrona antybot zostala wylaczona przez {player}");
                messages.getData().set("logs.antibot_enable", "Ochrona antybot zostala wlaczona przez {player}");
                messages.getData().set("logs.different_location", "&eGracz &c{player} &ezalogowal sie z innej lokalizacji");
                messages.getData().set("command_only_for_players", "Ta komenda jest przeznaczona tylko dla graczy");
                ...
                messages.getData().set("logs.multi_accounts", "Player {player} has multiple accounts: {accounts}");
                ...
                messages.getData().set("logs.different_location", "The {player} logged in from a different location");
                messages.getData().set("command_only_for_players", "This command is for players only");
